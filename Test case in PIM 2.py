...
time.sleep(5)
driver.find_element(By.NAME, "firstName").send_keys("Dhayalan")
time.sleep(10)
...
driver.find_element(By.XPATH, "//div[@class='orangehrm-edit-employee-content']//div[2]//div[1]//div[1]//div[1]//div[2]//input[1]").send_keys(Keys.CONTROL+"a")
driver.find_element(By.XPATH, "//div[@class='orangehrm-edit-employee-content']//div[2]//div[1]//div[1]//div[1]//div[2]//input[1]").send_keys(Keys.DELETE)
time.sleep(5)
driver.find_element(By.XPATH, "//div[@class='orangehrm-edit-employee-content']//div[2]//div[1]//div[1]//div[1]//div[2]//input[1]").send_keys("0311")
driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div[2]/div[2]/div/div[2]/div/div/input").send_keys(Keys.CONTROL+"a")
driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div[2]/div[2]/div/div[2]/div/div/input").send_keys(Keys.DELETE)
...
# Html = driver.page_source
# print(Html)
driver.find_element(By.XPATH, "//span[normalize-space()='Married']").click()
time.sleep(5)
driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[3]/div[2]/div[1]/div/div[2]/div/div/input").send_keys(Keys.CONTROL+"a")
driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[3]/div[2]/div[1]/div/div[2]/div/div/input").send_keys(Keys.DELETE)
...
time.sleep(10)
print("Sucessfully employee addition")
